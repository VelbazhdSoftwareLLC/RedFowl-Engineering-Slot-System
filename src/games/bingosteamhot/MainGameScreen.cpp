...
static SDL_Rect bingoCardsCoordinates[] = { { OFFSET_X + 92, OFFSET_Y + 606 }, {
		OFFSET_X + 518, OFFSET_Y + 606
	}, { OFFSET_X + 943, OFFSET_Y + 606 }, {
		OFFSET_X + 92, OFFSET_Y + 677
	}, { OFFSET_X + 518, OFFSET_Y + 677 }, {
...
static SDL_Rect buttonsCoordinates[] = { { OFFSET_X + 757, OFFSET_Y + 746 }, {
		OFFSET_X + 1161, OFFSET_Y + 735
	}, { OFFSET_X + 757, OFFSET_Y + 792 }, {
		OFFSET_X + 519, OFFSET_Y + 758
	}, { OFFSET_X + 411, OFFSET_Y + 758 }, {
		OFFSET_X + 302, OFFSET_Y + 758
	}, { OFFSET_X + 757, OFFSET_Y + 839 }, {
		OFFSET_X + 628, OFFSET_Y + 758
	}, { OFFSET_X + 965, OFFSET_Y + 746 }, {
		OFFSET_X + 193, OFFSET_Y + 758
	}, { OFFSET_X + 84, OFFSET_Y + 758 },
};

static SDL_Rect symbolsCoordinates[][3] = { { {
			OFFSET_X + 298, OFFSET_Y + 118, 0, 0
		},
		{ OFFSET_X + 298, OFFSET_Y + 266, 0, 0 }, {
			OFFSET_X + 298, OFFSET_Y
			+ 414, 0, 0
		}
	}, { { OFFSET_X + 474, OFFSET_Y + 118, 0, 0 }, {
			OFFSET_X + 474, OFFSET_Y + 266, 0, 0
		}, {
			OFFSET_X + 474, OFFSET_Y + 414, 0, 0
		}
	}, { {
			OFFSET_X + 651, OFFSET_Y + 118, 0,
			0
		}, {
			OFFSET_X + 651, OFFSET_Y + 266, 0, 0
		}, {
			OFFSET_X + 651, OFFSET_Y + 414, 0, 0
		}
	}, { {
			OFFSET_X + 827, OFFSET_Y + 118, 0,
			0
		}, {
			OFFSET_X + 827, OFFSET_Y + 266, 0, 0
		}, {
			OFFSET_X + 827, OFFSET_Y + 414, 0, 0
		}
	}, { {
			OFFSET_X + 1003, OFFSET_Y + 118,
			0, 0
		}, {
